...
public class teste {
    ...
    public static void main(String[] args) throws IOException{
        ...
        //TreeMap<Integer,ArrayList<Integer>> reviewData = readReviewData("u.data");
        Scanner read = new Scanner(new FileReader("u.data"));
...
/*
    public static TreeMap<> readReviewData(String filename) throws IOException{
